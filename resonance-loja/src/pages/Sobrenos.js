  ...
  return (
    <div className="sobrenos">
      ...
      <img src={Banner} width="100%"/>
        ...
        <main>
          <section className="sessaoHistory">
            <article>
            ...
            <img src={SobrenosImagemOne} width="516px"/>
          </section>
          <section className="sessaoHistory" style={{background: "#121212", color: "#fff"}}>
            <img src={SobrenosImagemTwo} width="516px"/>
            <article>
          ...
          <section className="sessaoHistory">
            ...
            <img src={SobrenosImagemTree} width="516px"/>
          </section>
          <section className="sessaoHistory" style={{background: "#6f5f40", color: "#fff"}}>
            <img src={SobrenosImagemFour} width="516px"/>
            <article>
